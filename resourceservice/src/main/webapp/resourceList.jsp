    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <table>
                ...
                <%
                    List<ResourceDb> resources = (List<ResourceDb>) request.getAttribute("resources");
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" action="download.do">
                            ...
                            <input hidden="true" name="resourcename" type="text" value="<%=resource.getTitle()%>">
